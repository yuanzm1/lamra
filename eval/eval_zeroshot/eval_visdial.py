...
def eval(args):
    ...
    query_data_collator = EvalDataCollator(tokenizer=tokenizer, processor=processor, dataset_type='visd')
    cand_data_collator = EvalDataCollator(tokenizer=tokenizer, processor=processor, dataset_type='visd')
