...
def eval(args):
    ...
    query_data_collator = EvalDataCollator(tokenizer=tokenizer, processor=processor, dataset_type='circo')
    cand_data_collator = EvalDataCollator(tokenizer=tokenizer, processor=processor, dataset_type='circo')
